<?php
    ...
    class Branch extends FormModel
    {
    	public $organisationId,$address,$county,$phoneNum,$name,$town,$postcode,$email;
		...
		public function rules()
        {
        	return array(
				...
				array('county, town', 'length', 'max'=>64),
				array('phoneNum', 'match', 'pattern'=> '/^0[0-9]{10}$/'),
				array('name','match', 'pattern'=>'/^[a-z]{1,30}$/'),
