...
class Customer extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('firstname, email, created, sex, ageGroup, ipAddress', 'required'),
			array('created', 'numerical', 'integerOnly'=>true),
			// array('sex', 'numerical', 'integerOnly' => true, 'min' => 1, 'max' => 3, 'message' => 'Please choose a valid sex.'),
			array('sex', 'match', 'pattern' => '/^[1-3]$/'),
			array('ageGroup', 'match', 'pattern' => '/^([4-9]|10)$/'),
			// array('ageGroup', 'numerical', 'integerOnly' => true, 'min' => 4, 'max' => 10, 'message' => 'Please use a valid age group.'),
			array('optIn', 'boolean'),
			...
			array('phoneNum, ipAddress', 'length', 'max'=>255),
